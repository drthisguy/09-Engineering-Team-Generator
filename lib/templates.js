class Templates {
    ...
    main(manager, cards) {
        ...
        <head>
            ...
            <title>Team Roster Profiler</title>
        </head>
        ...
        <body>
            ...
            <section class="container mt-5">
                <div class="card text-center bg-primary">
                    <div class="card-header text-white"> Team Roster Profiler </div>
                    <div class="jumbotron">
                        ...
                        <div class="card border-dark m-3">
                              ...
                              <div class="card-body">
                                ...
                                <p class="card-text text-left">Email: <a href="mailto:${manager.email}">${manager.email}</a></p>
    ...
    engineer(engineer) {
        ...
        <div class="card border-primary m-3">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-left">Email: <a href="mailto:${engineer.email}">${engineer.email}</a></p>
            <p class="card-text text-left">Emplyoyee id #: ${engineer.id}</p>
            <p class="card-text text-left">Github Profile: <a href="https://github.com/${engineer.github}">${engineer.github}</a></p>
          </div>
        </div>
      </div>`
    }
    ...
    intern(intern) {
        ...
        <div class="card border-primary m-3">
          ...
          <div class="card-body">
            ...
            <p class="card-text text-left">Email: <a href="mailto:${intern.email}">${intern.email}</a></p>
            <p class="card-text text-left">Emplyoyee id #: ${intern.id}</p> <p class="card-text text-left">School: ${intern.school}</p>
          </div>
        </div>
      </div>`
    }
